...
| `packages/fleet-pi-extension/src/{lifecycle,commands,keybinds,tools,tui,session-bridge,config-bridge,adapters,compat,diagnostics}/` | Current doctrinal homes for Pi-specific ownership during Waves 12-13 |
