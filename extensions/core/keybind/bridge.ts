/**
 * infra-keybind/bridge.ts — globalThis 런타임 브릿지
 *
...
export { INFRA_KEYBIND_KEY } from "./types.js";
...
export function getKeybindAPI(): InfraKeybindAPI {
  return (globalThis as any)[INFRA_KEYBIND_KEY];
}
