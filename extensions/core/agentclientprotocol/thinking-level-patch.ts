...
type UiThinkingLevel = "off" | "minimal" | "low" | "medium" | "high" | "xhigh";
...
export function getAcpAvailableThinkingLevels(model: PatchableModel | undefined): UiThinkingLevel[] | null {
