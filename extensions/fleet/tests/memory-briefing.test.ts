...
import { briefingQuery } from "../memory/briefing.js";
import { resolveMemoryPaths } from "../memory/paths.js";
import { writeWikiEntry } from "../memory/store.js";
...
async function makeTempRoot(): Promise<string> {
  const root = await mkdtemp(path.join(os.tmpdir(), "fleet-memory-briefing-"));
