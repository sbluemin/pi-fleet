...
vi.mock("../../core/agentclientprotocol/executor.js", () => ({
...
import { getRunById, getVisibleRun, resetRuns } from "../bridge/streaming/stream-store.js";
import { CARRIER_FRAMEWORK_KEY } from "../shipyard/carrier/types.js";
import { isStaleExtensionContextError, syncCurrentWidget, syncWidget } from "../bridge/panel/widget-sync.js";
