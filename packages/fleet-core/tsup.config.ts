...
export default defineConfig({
  entry: {
    ...
    gfleet: "src/gfleet/index.ts",
    "gfleet/ipc": "src/gfleet/ipc/protocol.ts",
    "gfleet/formation": "src/gfleet/formation/tmux.ts",
    "bridge/run-stream": "src/bridge/run-stream/index.ts",
    "bridge/carrier-panel": "src/bridge/carrier-panel/index.ts",
    "bridge/carrier-control": "src/bridge/carrier-control/index.ts",
