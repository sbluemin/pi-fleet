...
export default defineConfig({
  entry: {
    ...
    "agent/shared": "src/services/agent/shared/index.ts",
    ...
    "agent/provider": "src/services/agent/provider/index.ts",
    ...
    "agent/dispatcher": "src/services/agent/dispatcher/index.ts",
