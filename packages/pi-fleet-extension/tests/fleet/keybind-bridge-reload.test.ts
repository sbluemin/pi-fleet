...
import type { CoreKeybindAPI, KeybindRegistration } from "../../src/bindings/config/keybind/types.js";
import { addBinding, getBindings, getKey } from "../../src/bindings/config/keybind/registry.js";
