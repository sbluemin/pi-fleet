...
```json
{
  "extensions": [
    ...
    "<path-to-pi-fleet>/extensions-infra",
    "<path-to-pi-fleet>/extensions-util"
  ]
}
```
...
>
> - `extensions/` — agent orchestration extensions
...
> - `extensions-util/` — utility extensions (improve-prompt, summarize, thinking-timer)
